    ...
    <Layout>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-pixel text-light mb-8 text-center">
            Latest in Geoscience
          </h2>
          ...
          <div className="text-center mt-10">
            <Link href="/articles" className="inline-flex items-center text-primary font-pixel text-sm hover:opacity-90">
              View all articles
      ...
      <section className="py-16 bg-dark-light">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-pixel text-light mb-8">
            Recent Publications
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-pixel text-white text-center mb-6">
              Stay Updated with GeoBit
            </h2>
            <p className="text-gray-300 text-center mb-8">
              Subscribe to our newsletter for the latest geoscience news, research breakthroughs, and exclusive content.
            </p>
            <SubscriptionForm
