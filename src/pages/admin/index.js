  ...
  return (
    <div className="max-w-md mx-auto bg-dark-card rounded-lg shadow-dark-md p-8 border border-dark-border">
      ...
      <div className="mt-8 pt-6 border-t border-dark-border">
        <h3 className="text-sm font-medium text-light mb-2">Having trouble signing in?</h3>
        <p className="text-xs text-light-muted mb-2">If you're experiencing issues with a persistent session:</p>
        <button
